...
export const updatePost = async (req, res) => {
  ...
  try {
    ...
    const { id: _, createdAt, userId, ...cleanPostData } = postData;
        ...
        postDetail: {
          update: {
            ...
            data: {
              ...
              ...(postDetail.size !== undefined && { size: postDetail.size }),
              ...(postDetail.daysVisit !== undefined && { daysVisit: postDetail.daysVisit }),
            },
          },
        },
      },
